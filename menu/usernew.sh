...
echo -e "=================================================="
echo -e "PATCH /ssh-crot HTTP/1.1[crlf]Host: [host][crlf]Host: ISIBUG[crlf]Upgrade: websocket[crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf][crlf]"
echo -e "=================================================="
echo -e "${CYAN}     Terimakasih sudah menggunakan"
echo -e "${CYAN}        script premium CROT"
echo -e "${LIGHT}=================================================="
