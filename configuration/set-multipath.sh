...
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/amahman/lol/main/configuration/vmess.txt"
...
systemctl stop nginx
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/amahman/lol/main/configuration/vless.txt"
chmod +x /etc/nginx/conf.d/xray.conf
