...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Tikusmerdeka/MT_TUNEL/master/gerung > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Tikusmerdeka/MT_TUNEL/master/gerung | grep $MYIP | awk '{print $2}')
